                        ...
                        <div class="col-lg-11 tile">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading"><h3>Story Titles</h3>
                                    ...
                                    <button class="btn btn-primary pull-right" data-title="write-post" data-toggle="modal" data-target="#newQuote" style='margin-top: -40px;' >
                                        New Quote
                                    </button>
                                </div>
                                                ...
                                                <table id="mytable" class="table table-bordred table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Isaac Newton</td>
                                                            <td>1852 - 1912</td>
                                                            <td><p data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#newQuote" ><span class="glyphicon glyphicon-pencil"></span></button></p></td>
                                ...
                                <div class="modal fade" id="newQuote" class="editQuote" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
                                                <h4 class="modal-title custom_align" id="Heading">New Quote</h4>
                                            </div>
                                            <div class="modal-body">

                                                <div class="form-group">
                                                    <label class="col-xs-3 control-label sr-only" for="author">Quote Author</label>
                                                    <input class="form-control " id="username" type="text" placeholder="Quot Author" style="width:100%;">
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-xs-3 control-label sr-only" for="year">Contact</label>
                                                    <input class="form-control " id="contact" type="number" placeholder="1890 - 2001" style="width:100%;">
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-xs-3 control-label sr-only" for="admin-level">The Quote</label>
                                                    <textarea name="quote" id="quote" class="form-control" placeholder="The quote...">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> Are you sure you want to delete this Quote?</div>
                                            </div>
                                            <div class="modal-footer ">
